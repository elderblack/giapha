...
export const DEVELOPMENT_PLAN: PlanPhase[] = [
  ...
  },
  {
    ...
    tasks: [
      { id: 'p5-t1', label: 'Chat 1-1 realtime (text, ảnh)' },
      { id: 'p5-t2', label: 'Nhóm chat: tạo tay và tự động theo nhánh' },
      { id: 'p5-t3', label: 'Typing indicator, online presence' },
      { id: 'p5-t4', label: 'Đọc/chưa đọc, badge count' },
      { id: 'p5-t5', label: 'Push notification cho tin nhắn' },
    ],
  },
  {
    id: 'p6',
